...
<Lollipop size="lg" client:load />

这个棒棒糖具有以下特点：

1. **电影同款设计**：根据您提供的 PNG 图片制作，完美还原了电影《功夫》中棒棒糖的外观
2. **真实质感**：使用实际的 PNG 图片作为糖果表面，而不是简单的颜色填充
...
<!-- 中号棒棒糖 -->
<Lollipop size="md" client:load />

<!-- 无动画效果的小号棒棒糖 -->
<Lollipop size="sm" animated={false} client:load />
```
