!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['exports'], e)
      : e(((t = 'undefined' != typeof globalThis ? globalThis : t || self).Color4Bg = {}));
})(this, function (t) {
  'use strict';
  function e(t, e) {
      ...
      return (
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function (t) {
              return t
                ? ((e = this), (r = (i = t)[0] - e[0]), (n = i[1] - e[1]), (s = i[2] - e[2]), r * r + n * n + s * s)
                : E(this);
              var e, i, r, n, s;
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var r = 0, n = 0, s = e.length; n < s; n += i)
                S.fromArray(e, n), (r = Math.max(r, this.bounds.center.squaredDistance(S)));
                ...
                s.forEach(function (t) {
                  t.program.transparent ? (t.program.depthTest ? h.push(t) : o.push(t)) : a.push(t),
                    ...
                    0 === t.renderOrder &&
                      t.program.depthTest &&
                      i &&
                      (t.worldMatrix.getTranslation(j), j.applyMatrix4(i.projectionViewMatrix), (t.zDepth = j.z));
                }),
  ...
  var V = function (t, e) {
    ...
    Z = (function (t) {
      function e() {
        ...
        r(this, e), ((t = i(this, e, [n, s, a, h])).onChange = function () {}), (t._target = t);
        var o = ['0', '1', '2', '3'];
        return l(
          t,
          new Proxy(t, {
      ...
      return (
        ...
        s(e, [
          ...
          },
          {
            key: 'set',
            value: function (t, e, i, r) {
              return t.length ? this.copy(t) : (W(this._target, t, e, i, r), this.onChange(), this);
            },
          },
          {
            key: 'rotateX',
          ...
          },
          {
            key: 'multiply',
            value: function (t, e) {
              return e ? X(this._target, t, e) : X(this._target, this._target, t), this.onChange(), this;
            },
          },
          {
            key: 'dot',
  ...
  var rt = (function (t) {
    function e() {
      ...
      return r(this, e), l((t = i(this, e, [n, s, a, h, o, u, c, f, d, g, v, p, m, y, _, b])), t);
    }
    return (
      o(e, t),
      s(e, [
        ...
        },
        {
          key: 'inverse',
          value: function () {
            var t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, k, M, A, T, F, R, S;
            return (
              (t = this),
        ...
        },
        {
          key: 'compose',
          value: function (t, e, i) {
            var r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, k, M;
            return (
              (n = e),
              (s = i),
              (a = this),
            ...
            return (
              (function (t, e, i, r) {
                var n = m([t[0], t[1], t[2]]),
                  s = m([t[4], t[5], t[6]]),
                  a = m([t[8], t[9], t[10]]);
                Q(t) < 0 && (n = -n), (i[0] = t[12]), (i[1] = t[13]), (i[2] = t[14]);
                var h = t.slice(),
                  o = 1 / n,
                  u = 1 / s,
                  l = 1 / a;
  ...
  var nt = new rt(),
    st = (function (t) {
      function e() {
        ...
        r(this, e), ((t = i(this, e, [n, s, a])).order = h), (t.onChange = function () {}), (t._target = t);
        var o = ['0', '1', '2'];
        return l(
          t,
          new Proxy(t, {
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return t.length
                ? this.copy(t)
                : ((this._target[0] = t), (this._target[1] = e), (this._target[2] = i), this.onChange(), this);
            },
          },
          {
            key: 'copy',
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return nt.fromQuaternion(t), this._target.fromRotationMatrix(nt, e), i || this.onChange(), this;
            },
          },
          {
            key: 'fromArray',
      ...
      return (
        ...
        s(e, [
          ...
          },
          {
            key: 'unproject',
            value: function (t) {
              return t.applyMatrix4(ht.inverse(this.projectionMatrix)), t.applyMatrix4(this.worldMatrix), this;
            },
          },
          {
            key: 'updateFrustum',
      ...
      return (
        ...
        s(e, [
          ...
          },
          {
            key: 'getNormalMatrix',
            value: function (t) {
              var e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, k, M, A, T, F, R, S, C;
              return (
                (e = this),
                (r = (i = t)[0]),
                (n = i[1]),
              ...
              if (((e || this.glState.textureUnits[t] !== this.id) && (this.gl.renderer.activeTexture(t), this.bind()), e)) {
                if (
                  ...
                  this.generateMipmaps &&
                    (this.gl.renderer.isWebgl2 || (pt(this.image.width) && pt(this.image.height))
                  ...
                  this.width
                    ...
                    : this.gl.texImage2D(this.target, 0, this.gl.RGBA, 1, 1, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, vt);
  ...
  var kt = Object.freeze({ __proto__: null, hexToRGB: xt, numberToRGB: Et, parseColor: wt }),
    Mt = (function (t) {
      function e(t) {
        var n;
        return r(this, e), Array.isArray(t) ? l(n, (n = i(this, e, f(t)))) : l(n, (n = i(this, e, f(wt.apply(kt, arguments)))));
      }
      return (
        o(e, t),
        s(e, [
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function (t) {
              var e, i, r;
              return (
                t.length ? ((i = this), (r = t), ((e = this)[0] = i[0] * r[0]), (e[1] = i[1] * r[1])) : Ft(this, this, t), this
              );
            },
          },
          {
            ...
            value: function (t) {
              var e, i, r;
              return (
                t.length ? ((i = this), (r = t), ((e = this)[0] = i[0] / r[0]), (e[1] = i[1] / r[1])) : Ft(this, this, 1 / t),
                this
              );
            },
          },
  ...
  var Bt = (function () {
    ...
    Ot = (function (t) {
      function e() {
        ...
        return r(this, e), ((t = i(this, e, [n, 6])).name = 'grid-array'), (t.speed = 56), t.start(), t;
      }
      return (
        o(e, t),
        s(e, [
          {
            key: '_initRtt',
            value: function () {
              (this.rtt = new _t(this.gl, { width: 2 * this.canvasW, height: 2 * this.canvasH })),
                (this.rttCamera = new lt(this.gl, { left: -0.5, right: 0.5, bottom: -0.5, top: 0.5, zoom: 1 })),
                ...
                (this.rttProgram = new D(this.gl, {
                  ...
                  uniforms: {
                    u_time: { value: 0 },
                    u_resolution: { value: new Ct(2 * this.canvasH, 2 * this.canvasH) },
                    ...
                    u_color_4: { value: new Mt(this.palette[4]) },
                    u_color_5: { value: new Mt(this.palette[5]) },
                  },
                })),
                (this.rttPlane = new gt(this.gl, { geometry: this.rttPlaneGeo, program: this.rttProgram })),
          ...
          },
          {
            ...
            value: function () {
              this._planeShader = new D(this.gl, {
                ...
                uniforms: { tMap: { value: this.rtt.texture }, uNoiseFactor: { value: 0 }, uTime: { value: 0 } },
              });
            },
          },
          {
            key: '_make',
            value: function () {
              var t = new Pt(this.gl, { width: this.canvasW, height: this.canvasH });
              new gt(this.gl, { geometry: t, program: this._planeShader }).setParent(this.scene);
            },
          },
          {
            key: '_resetColors',
            value: function () {
              (this.rttProgram.uniforms.u_color_0.value = new Mt(this.palette[0])),
                ...
                (this.rttProgram.uniforms.u_color_4.value = new Mt(this.palette[4])),
                (this.rttProgram.uniforms.u_color_5.value = new Mt(this.palette[5]));
            },
          },
          {
            key: '_animate',
            ...
            value: function (t, e) {
              switch (t) {
                case 'scale':
                  ...
                  break;
                case 'size':
                  this.rttProgram.uniforms.u_size.value = [parseFloat(e), parseFloat(e)];
                  break;
                case 'u_w':
                  (this.rttProgram.uniforms.u_w.value = parseFloat(e)),
                    (this.rttProgram.uniforms.u_x.value = (1 - parseFloat(e)) / 2);
                  break;
                case 'u_h':
                  (this.rttProgram.uniforms.u_h.value = parseFloat(e)),
                    (this.rttProgram.uniforms.u_y.value = (1 - parseFloat(e)) / 2);
                  break;
                case 'amplitude':
